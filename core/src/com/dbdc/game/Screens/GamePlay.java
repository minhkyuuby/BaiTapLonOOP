...
public class GamePlay extends DefaultScreen  implements AnimationController.AnimationListener {

    private SceneManager sceneManager;
    private SceneAsset sceneAsset;
    private Scene playerScene, enemyScene;
    ...
    public void show() {
        ...
        enemyScene.animationController.setAnimation("Idle", -1);
...
//        scene.modelInstance.transform.rotate(Vector3.Y, 10f * deltaTime);
        ...
        camera.lookAt(new Vector3(currentPosition.x,currentPosition.y + 3,currentPosition.z));
        camera.update();

        if (Gdx.input.isKeyPressed(Input.Keys.SPACE)) {
            playerScene.animationController.action("Jump", 1, 1f, this, 0.25f);
        }

        if (Gdx.input.isKeyPressed(Input.Keys.LEFT)) {
            playerScene.animationController.action("AttackSpinning", 1, 1f, this, 0.25f);
        }
        // render
    ...
    private void processInput(float deltaTime) {
        ...
        if (Gdx.input.isKeyPressed(Input.Keys.A)) {
            playerTransform.rotate(Vector3.Y, rotationSpeed * deltaTime * 2f);
        }
